module fp_add #(parameter int WIDTH=64)(
    ...
    always_comb begin
        ...
        // ========================================================
            ...
            // ----------------------------------------------------
            // Select number with larger exponent/significand
            // ----------------------------------------------------
            ...
            // ====================================================
                ...
                result_sig =
                    arithmetic_result[SIG_WIDTH-1:0];
                ...
                // Subtraction:
                //
                // Need to shift left until leading bit = 1.
                //
                // Fixed number of iterations makes this
                // synthesizable.
                // ------------------------------------------------
